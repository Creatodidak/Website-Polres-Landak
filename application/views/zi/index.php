 ...
 <table class="table  table-bordered table-hover" style="font-size:small">
  <thead class="table-info">
   ...
   <tbody>
      ...
      <tr>
         <th scope="row"><?php echo $no++ ?></th>
         <td><i class="fa fa-file-pdf-o text-danger" aria-hidden="true"></i> DATA BHABIN LANDAK KEP KAPOLDA.pdf
</td>
         <td><a class="text-success" href="<?php echo base_url("assets/zi/DATA BHABIN LANDAK KEP KAPOLDA.pdf");?>"><i class="fa fa-download" aria-hidden="true"></i></a></td>
      </tr>
      ...
      <tr>
         <th scope="row"><?php echo $no++ ?></th>
         <td><i class="fa fa-file-pdf-o text-danger" aria-hidden="true"></i> Data Kasus Polres Landak Tahun 2020.pdf
</td>
         <td><a class="text-success" href="<?php echo base_url("assets/pressrelease/data1.pdf");?>"><i class="fa fa-download" aria-hidden="true"></i></a></td>
      </tr>
