          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('admin/profil'); ?>" class="btn btn-default btn-flat">Akun Saya</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url('admin/laporan'); ?>">
            <i class="fa fa-globe"></i> <span>Laporan</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('admin/laporandivhumas'); ?>">
            <i class="fa fa-globe"></i> <span>Laporan Div Humas</span>
          </a>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li ><a href="<?php echo base_url('admin/inputlaphar'); ?>"><i class="fa fa-pencil"></i> Input Link Media Online</a></li>
            <li ><a href="<?php echo base_url('admin/inputlaphardivhumas'); ?>"><i class="fa fa-pencil"></i> Input Link Div Humas</a></li>


            <?php if($this->session->userdata('role')==admin){?>
            <li ><a href="<?php echo base_url('admin/laphar'); ?>"><i class="fa fa-list"></i> Data Blog</a></li>
