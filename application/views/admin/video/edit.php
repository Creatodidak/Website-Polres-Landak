...
<div class="modal fade" id="modedit">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <input type="hidden" name="id_video" id="" class="form-control" value="<?php echo $r->id_video; ?>">
      	<div class="modal-body">
            ...
            <div class="form-group">
               ...
               <input type="text" name="link_video" id="" class="form-control" value="<?php echo $r->link_video; ?>">
            </div>
      	</div>
