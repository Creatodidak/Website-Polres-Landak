...
<div class="modal fade" id="modedit">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <input type="hidden" name="id_staff" id="" class="form-control" value="<?php echo $r->id_staff; ?>">
      	<div class="modal-body">
      		<div class="form-group">
               <label for="">NIP Staff</label>
               <input type="text" name="nip_staff" id="" class="form-control" value="<?php echo $r->nip_staff; ?>">
            </div>
            <div class="form-group">
               <label for="">Nama Staff</label>
               <input type="text" name="nama_staff" id="" class="form-control" value="<?php echo $r->nama_staff; ?>">
            </div>
            <div class="form-group">
               <label for="">Jabatan Staff</label>
               <input type="text" name="jabatan_staff" id="" class="form-control" value="<?php echo $r->jabatan_staff; ?>">
            </div>
            <div class="form-group">
               <label for="">Tempat Lahir Staff</label>
               <input type="text" name="teml_staff" id="" class="form-control" value="<?php echo $r->teml_staff; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="row">
               ...
               <div class="col-md-9">
                  <div class="form-group">
                     ...
                     <input type="file" name="filestaff" id="" class="form-control">
                  </div>
               </div>
            </div>
      	</div>
