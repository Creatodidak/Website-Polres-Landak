      ...
      <div class="modal-content">
      	...
      	<div class="modal-body">
      		<div class="form-group">
      			...
      			<input type="text" name="nip_staff" id="" class="form-control">
      		</div>
            <div class="form-group">
               <label for="">Nama Staff</label>
               <input type="text" name="nama_staff" id="" class="form-control">
            </div>
            <div class="form-group">
               <label for="">Jabatan Staff</label>
               <input type="text" name="jabatan_staff" id="" class="form-control">
            </div>
            <div class="form-group">
               <label for="">Tempat Lahir Staff</label>
               <input type="text" name="teml_staff" id="" class="form-control">
            </div>
            <div class="form-group">
