...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Laphar <?php echo $button ?></h2>
        <form action="<?php echo $action; ?>" method="post">
	    <div class="form-group">
            <label for="varchar">Laphar <?php echo form_error('laphar') ?></label>
            <input type="text" class="form-control" name="laphar" id="laphar" placeholder="Laphar" value="<?php echo $laphar; ?>" />
        </div>
	    <div class="form-group">
