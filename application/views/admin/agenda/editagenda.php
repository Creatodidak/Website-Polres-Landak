      ...
      <div class="box box-solid">
         ...
         <div class="box-body">
            <div class="form-group">
               ...
               <input type="text" name="judul_agenda" id="" class="form-control" value="<?php echo $r->judul_agenda; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="text" name="tempat_agenda" id="" class="form-control" value="<?php echo $r->tempat_agenda; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="text" name="waktu_agenda" id="" class="form-control" value="<?php echo $r->waktu_agenda; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="file" name="fileagenda" id="" class="form-control">
            </div>
         </div>
