      ...
      <div class="box box-solid">
         ...
         <div class="box-body">
            <div class="form-group">
               ...
               <input type="text" name="judul_agenda" id="" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="text" name="tempat_agenda" id="" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="text" name="waktu_agenda" id="" class="form-control">
            </div>
            <div class="form-group">
