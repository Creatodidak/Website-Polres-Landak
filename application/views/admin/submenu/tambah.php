   ...
   <div class="modal-dialog">
      <div class="modal-content">
      	...
      	<div class="modal-body">
            <p>Custom Link</p>
            <form id="fcuslink">
            <input type="hidden" name="id_menu" id="" class="form-control" value="<?php echo $this->uri->segment(3); ?>">
      		<div class="form-group">
      			<label for="">Nama Sub Menu</label>
      			<input type="text" name="nama_submenu" id="" class="form-control">
      		</div>
            <div class="form-group">
               <label for="">Link Sub Menu</label>
               <input type="text" name="link_submenu" id="" class="form-control">
            </div>
            </form>
            ...
            <div class="form-group">
               ...
               <select name="link_submenu" id="" class="form-control select" style="width:100%;">
